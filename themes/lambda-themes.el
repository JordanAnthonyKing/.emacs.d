...
(defun lambda-themes-create (variant theme-name)
  ...
  (let ((class '((class color) (min-colors 89))) ;;     ~~Dark~~                                                            ~~Light~~
        ;; basic
        (lambda-fg          (cond ((eq variant 'dark)  "#000000") ((eq variant 'dark-faded) "#eceff1") ((eq variant 'light) "#0C0D0D") ((eq variant 'light-faded) "#282b35")))
        (lambda-bg          (cond ((eq variant 'dark)  "#ffffff") ((eq variant 'dark-faded) "#282b35") ((eq variant 'light) "#FFFEFD") ((eq variant 'light-faded) "#fcfaf6")))
        ;; highlighting
        (lambda-ultralight  (cond ((eq variant 'dark)  "#58595b") ((eq variant 'dark-faded) "#525868") ((eq variant 'light) "#EBE9E7") ((eq variant 'light-faded) "#cfd6e2")))
        (lambda-highlight   (cond ((eq variant 'dark)  "#424243") ((eq variant 'dark-faded) "#444B5c") ((eq variant 'light) "#F5F2F0") ((eq variant 'light-faded) "#dbe1eb")))
        (lambda-lowlight    (cond ((eq variant 'dark)  "#000000") ((eq variant 'dark-faded) "#3c4353") ((eq variant 'light) "#F8F6F4") ((eq variant 'light-faded) "#e3e7ef")))
        ;; attention
        (lambda-strong      (cond ((eq variant 'dark)  "#6d6a5c") ((eq variant 'dark-faded) "#959eb1") ((eq variant 'light) "#706F6F") ((eq variant 'light-faded) "#727d97")))
        (lambda-meek        (cond ((eq variant 'dark)  "#47453c") ((eq variant 'dark-faded) "#8791A7") ((eq variant 'light) "#C1C1C1") ((eq variant 'light-faded) "#C8CDD8")))
        (lambda-mild        (cond ((eq variant 'dark)  "#393830") ((eq variant 'dark-faded) "#333a47") ((eq variant 'light) "#E3E1E0") ((eq variant 'light-faded) "#eceff1")))
        (lambda-faint       (cond ((eq variant 'dark)  "#21201c") ((eq variant 'dark-faded) "#525868") ((eq variant 'light) "#EBE9E7") ((eq variant 'light-faded) "#cfd6e2")))
        ;; accent
        ...
        (lambda-red         (cond ((eq variant 'dark)  "#ff3300") ((eq variant 'dark-faded) "#bf616a") ((eq variant 'light) "#EC6A5E") ((eq variant 'light-faded) "#960d36")))
        (lambda-green       (cond ((eq variant 'dark)  "#00802d") ((eq variant 'dark-faded) "#8eb89d") ((eq variant 'light) "#005A02") ((eq variant 'light-faded) "#00796b")))
        (lambda-blue        (cond ((eq variant 'dark)  "#0091ff") ((eq variant 'dark-faded) "#81a1c1") ((eq variant 'light) "#4C4CFF") ((eq variant 'light-faded) "#30608c")))
        (lambda-yellow      (cond ((eq variant 'dark)  "#ffb400") ((eq variant 'dark-faded) "#e9b85d") ((eq variant 'light) "#e0a500") ((eq variant 'light-faded) "#e0a500")))
        (lambda-purple      (cond ((eq variant 'dark)  "#f400bc") ((eq variant 'dark-faded) "#9D67E6") ((eq variant 'light) "#833AE6") ((eq variant 'light-faded) "#833AE6"))))
...
;;;;; Default
     ...
     `(cursor               ((,class (:background ,lambda-white))))
 ;; :weight light
     `(fringe               ((,class (:background ,lambda-bg))))
     `(hl-line              ((,class (:background ,lambda-lowlight))))
     ...
     `(minibuffer-prompt    ((,class (:background ,lambda-bg :foreground ,lambda-yellow))))
     `(vertical-border      ((,class (:foreground ,lambda-bg))))
     `(internal-border      ((,class (:background ,lambda-bg :foreground ,lambda-bg))))
     `(show-paren-match     ((,class (:background ,lambda-ultralight :foreground ,lambda-yellow :weight bold))))
     `(show-paren-mismatch  ((,class (:background ,lambda-ultralight :foreground ,lambda-red :weight bold :box t))))
     `(link                 ((,class (:foreground ,lambda-purple :underline t))))
...
;;;;; Basic faces
     ...
     `(alert-low-face       ((,class (:foreground ,lambda-yellow))))
     `(trailing-whitespace  ((,class (:background ,lambda-mild))))
     `(escape-glyph         ((,class (:foreground ,lambda-blue))))
     `(highlight            ((,class (:background ,lambda-highlight))))
     `(homoglyph            ((,class (:foreground ,lambda-blue))))
     `(match                ((,class (:background ,lambda-lowlight :background ,lambda-blue))))

;;;;; Built-in syntax (Font-Lock)
     `(font-lock-builtin-face        ((,class (:foreground ,lambda-fg))))
     `(font-lock-constant-face       ((,class (:foreground ,lambda-fg))))
     `(font-lock-comment-face        ((,class (:foreground ,lambda-fg :slant italic))))
     `(font-lock-function-name-face  ((,class (:foreground ,lambda-fg :weight bold))))
     `(font-lock-keyword-face        ((,class (:foreground ,lambda-fg))))
     `(font-lock-string-face         ((,class (:foreground ,lambda-green))))
     ;; `(font-lock-variable-name-face  ((,class (:foreground ,lambda-cyan :weight normal))))
     `(font-lock-variable-name-face  ((,class (:foreground ,lambda-fg))))
     `(font-lock-type-face           ((,class (:foreground ,lambda-fg))))
     `(font-lock-warning-face        ((,class (:foreground ,lambda-red :weight bold))))
     `(font-lock-preprocessor-face   ((,class (:foreground ,lambda-fg))))

;;;;; Childframes
;;;;;; Mini-Frame
     `(mini-popup-background ((,class (:background ,lambda-white))))
     `(mini-popup-border     ((,class (:background ,lambda-white))))
...
;;;;;; Company-mode
     ...
     ;; `(company-preview-search                      ((,class (:background ,lambda-blue))))
...
;;;;;; Consult
     ...
     `(consult-preview-line                        ((,class (:foreground ,lambda-yellow :background ,lambda-lowlight))))
...
;;;;;; Corfu
     ...
     `(corfu-bar                                   ((,class (:foreground ,lambda-black))))
     `(corfu-border                                ((,class (:background ,lambda-white))))
     `(corfu-current                               ((,class (:foreground ,lambda-white :background ,lambda-black :weight bold))))
     `(corfu-default                               ((,class (:foreground ,lambda-black :background ,lambda-white))))
...
;;;;;; Helm
     ...
     ;; `(helm-source-header                            ((,class (:foreground ,lambda-blue))))
     ...
     ;; `(helm-ff-executable                            ((,class (:foreground ,lambda-yellow))))
...
;;;;;; Ivy
     ...
     ;; `(ivy-minibuffer-match-face-1                 ((,class (:foreground ,lambda-yellow))))
     ;; `(ivy-minibuffer-match-face-2                 ((,class (:foreground ,lambda-yellow))))
     ;; `(ivy-minibuffer-match-face-3                 ((,class (:foreground ,lambda-yellow))))
     ;; `(ivy-minibuffer-match-face-4                 ((,class (:foreground ,lambda-yellow))))

;;;;;; Orderless
     `(orderless-match-face-0                      ((,class (:background ,lambda-yellow :foreground ,lambda-bg :weight bold))))
     `(orderless-match-face-1                      ((,class (:background ,lambda-blue :foreground ,lambda-bg :weight bold))))
     `(orderless-match-face-2                      ((,class (:background ,lambda-yellow :foreground ,lambda-bg :weight bold))))
...
;;;;;; Selectrum
     ...
     `(selectrum-prescient-primary-highlight         ((,class (:weight bold :foreground ,lambda-blue))))
     ...
     `(selectrum-quick-keys-highlight                ((,class (:foreground ,lambda-yellow))))
...
;;;;;; Ediff
     ...
     `(js2-external-variable                     ((,class (:underline (:color ,lambda-blue :style wave)))))
     ...
     `(js2-function-param                        ((,class (:background unspecified :foreground ,lambda-blue))))
     `(js2-function-call                         ((,class (:background unspecified :foreground ,lambda-blue))))
     `(js2-instance-member                       ((,class (:background unspecified :foreground ,lambda-yellow))))
     `(js2-private-member                        ((,class (:background unspecified :foreground ,lambda-yellow))))
     `(js2-private-function-call                 ((,class (:background unspecified :foreground ,lambda-blue))))
...
;;;;;; Eglot
     `(eglot-highlight-symbol-face          ((,class (:foreground ,lambda-white :weight bold))))
     ...
     `(eglot-inlay-hint-parameter-face      ((,class (:foreground ,lambda-blue :weight bold))))
...
;;;;;; Change-Log and Log-View (`vc-print-log' and `vc-print-root-log')
     ...
     `(change-log-list ((,class :foreground ,lambda-yellow)))
     ...
     `(log-view-file              ((,class :inherit bold :foreground ,lambda-blue)))
     `(log-view-message           ((,class :foreground ,lambda-meek :background ,lambda-highlight)))

;;;;;; Magit
     `(magit-header-line            ((,class (:foreground ,lambda-white :underline nil :background ,lambda-black :weight bold))))
     `(magit-header-line-log-select ((,class (:foreground ,lambda-white :underline nil :background ,lambda-black :weight bold))))
     `(magit-section-heading        ((,class (:foreground ,lambda-red))))
     `(magit-dimmed                 ((,class (:foreground ,lambda-meek))))
     `(magit-blame-dimmed           ((,class (:foreground ,lambda-meek))))
     `(magit-branch-local           ((,class (:foreground ,lambda-green))))
     `(magit-branch-remote          ((,class (:foreground ,lambda-blue))))
     `(magit-hash                   ((,class (:foreground ,lambda-yellow))))
     `(magit-hash                   ((,class (:foreground ,lambda-yellow))))
     `(magit-log-author             ((,class (:foreground ,lambda-red))))
     `(magit-log-date               ((,class (:foreground ,lambda-faint))))
     ...
     ;; (magit-cherry-unmatched                    (:foreground ,lambda-blue))
     ...
     ;; (magit-diff-hunk-heading-selection         (:background ,lambda-faint  :foreground ,lambda-yellow))
     ;; (magit-diff-lines-heading                  (:background ,lambda-yellow :foreground ,lambda-strong))
     ...
     ;; (magit-log-date                            (:foreground ,lambda-blue))
     ...
     ;; (magit-reflog-other                        (:foreground ,lambda-blue))
     ...
     ;; (magit-section-heading-selection           (:foreground ,lambda-blue))
     ;; (magit-section-highlight                   (:background ,lambda-faint))
     ;; (magit-sequence-drop                       (:foreground ,lambda-blue))
     ;; (magit-sequence-head                       (:foreground ,lambda-blue))
     ;; (magit-sequence-part                       (:foreground ,lambda-blue))
     ...
     ;; (magit-signature-expired                   (:foreground ,lambda-yellow))
...
;;;;; Directories
;;;;;; All The Icons Dired
     `(all-the-icons-dired-dir-face   ((,class (:foreground ,lambda-blue))))

;;;;;;  Dired
     `(dired-directory                ((,class (:foreground ,lambda-yellow))))
     `(dired-symlink                  ((,class (:slant italic))))
     `(dired-mark                     ((,class (:foreground ,lambda-strong))))
     `(dired-marked                   ((,class (:foreground ,lambda-red))))
...
;;;;;; dired+
     ...
     `(diredp-symlink                            ((,class (:foreground ,lambda-yellow))))
     ...
     `(diredp-link-priv                          ((,class (:foreground ,lambda-blue  :background ,lambda-blue))))
     `(diredp-read-priv                          ((,class (:foreground ,lambda-red  :background ,lambda-red))))
     `(diredp-write-priv                         ((,class (:foreground ,lambda-blue :background ,lambda-blue))))

;;;;;; Dired Colors (Diredfl)
     `(diredfl-write-priv                            ((,class (:foreground ,lambda-red))))
     `(diredfl-tagged-autofile-name                  ((,class (:foreground ,lambda-bg))))
     `(diredfl-symlink                               ((,class (:foreground ,lambda-red))))
     `(diredfl-read-priv                             ((,class (:foreground ,lambda-red))))
     `(diredfl-rare-priv                             ((,class (:foreground ,lambda-red :background ,lambda-red))))
     ...
     `(diredfl-no-priv                               ((,class (:foreground ,lambda-red))))
     `(diredfl-mode-line-flagged                     ((,class (:foreground ,lambda-red))))
     `(diredfl-mode-line-marked                      ((,class (:foreground ,lambda-blue))))
     `(diredfl-link-priv                             ((,class (:foreground ,lambda-red))))
     `(diredfl-ignored-file-name                     ((,class (:foreground ,lambda-meek))))
     `(diredfl-flag-mark-line                        ((,class (:foreground ,lambda-red))))
     `(diredfl-flag-mark                             ((,class (:foreground ,lambda-red :background ,lambda-blue))))
     `(diredfl-file-suffix                           ((,class (:foreground ,lambda-meek))))
     `(diredfl-file-name                             ((,class (:foreground ,lambda-fg))))
     `(diredfl-executable-tag                        ((,class (:foreground ,lambda-red))))
     `(diredfl-exec-priv                             ((,class (:foreground ,lambda-red))))
     ...
     `(diredfl-deletion-file-name                    ((,class (:foreground ,lambda-red))))
     `(diredfl-deletion                              ((,class (:foreground ,lambda-red :background ,lambda-red))))
...
;;;;;; Meow
     ...
     `(meow-insert-cursor         ((,class (:background ,lambda-red))))
     `(meow-keypad-cursor         ((,class (:background ,lambda-yellow))))
     `(meow-motion-cursor         ((,class (:background ,lambda-green))))
     `(meow-kmacro-cursor         ((,class (:background ,lambda-blue))))
...
;;;;;; iEdit Mode
     `(iedit-occurrence                          ((,class (:foreground ,lambda-bg :background ,lambda-yellow))))
     `(iedit-read-only-occurrence                ((,class (:foreground ,lambda-bg :background ,lambda-yellow))))

;;;;;; Line numbers
     `(line-number                               ((,class (:foreground ,lambda-ultralight))))
     ;; `(line-number-current-line                  ((,class (:foreground ,lambda-white :background ,lambda-faint))))
     `(line-number-current-line                  ((,class (:foreground ,lambda-white))))
     ;; `(linum                                     ((,class (:foreground ,lambda-faint :background ,lambda-mild))))
     ;; `(linum-highlight-face                      ((,class (:foreground ,lambda-yellow :background ,lambda-faint))))
     ;; `(linum-relative-current-face               ((,class (:foreground ,lambda-yellow :background ,lambda-faint))))
...
;;;;;; Undo-tree
     ...
     ;; `(undo-tree-visualizer-unmodified-face      ((,class (:foreground ,lambda-blue))))
...
;;;;;; Cider
     ...
     `(cider-deprecated-face                     ((,class (:background ,lambda-faint :foreground ,lambda-yellow))))
     `(cider-enlightened-local-face              ((,class (:foreground ,lambda-yellow :weight bold))))
     ...
     `(cider-test-error-face                     ((,class (:background ,lambda-yellow))))
     `(cider-test-success-face                   ((,class (:background ,lambda-green))))
     `(cider-traced                              ((,class (:background ,lambda-blue))))
...
;;;;;; Lsp
     `(lsp-lsp-flycheck-warning-unnecessary-face ((,class (:underline (:color ,lambda-yellow :style wave)))
     ...
     `(lsp-ui-sideline-current-symbol            ((,class (:foreground ,lambda-blue))))
...
;;;;;; Customize faces
     ...
     `(custom-changed                                ((,class (:foreground ,lambda-blue))))
     `(custom-modified                               ((,class (:foreground ,lambda-blue))))
     `(custom-face-tag                               ((,class (:foreground ,lambda-fg :bold t))))
     `(custom-variable-tag                           ((,class (:foreground ,lambda-fg :bold t))))
     `(custom-invalid                                ((,class (:foreground ,lambda-yellow))))
     `(custom-visibility                             ((,class (:foreground ,lambda-blue))))
     `(custom-state                                  ((,class (:foreground ,lambda-blue))))
     `(custom-link                                   ((,class (:foreground ,lambda-blue))))
     ...
     `(custom-button-pressed                         ((,class (:foreground ,lambda-fg :background ,lambda-blue :inverse-video nil :box (:line-width 1 :color ,lambda-blue :style nil)))))
...
;;;;;; Highlight Indentation Guides
     `(highlight-indent-guides-stack-odd-face        ((,class (:foreground ,lambda-yellow))))
     `(highlight-indent-guides-stack-even-face       ((,class (:foreground ,lambda-yellow))))
     `(highlight-indent-guides-top-odd-face          ((,class (:foreground ,lambda-yellow))))
     `(highlight-indent-guides-top-even-face         ((,class (:foreground ,lambda-yellow))))
     `(highlight-indent-guides-odd-face              ((,class (:foreground ,lambda-yellow))))
...
;;;;;; Pulse
     `(pulse-highlight-face       ((,class (:background ,lambda-yellow))))
     `(pulse-highlight-start-face ((,class (:background ,lambda-yellow))))
...
;;;;;; Tab-bar
     ...
     `(tab-bar-tab                ((,class (:foreground ,lambda-white :weight bold))))
     `(tab-bar-tab-inactive       ((,class (:foreground ,lambda-faint))))
...
;;;;;; Transient
     `(transient-key                             ((,class (:foreground ,lambda-yellow :weight bold))))
     `(transient-heading                         ((,class (:foreground ,lambda-blue))))
     `(transient-argument                        ((,class (:foreground ,lambda-purple))))
     `(transient-unreachable                     ((,class (:foreground ,lambda-faint))))
     `(transient-inapt-suffix                    ((,class (:foreground ,lambda-faint))))
     `(transient-inactive-value                  ((,class (:foreground ,lambda-faint))))
     `(transient-inactive-argument               ((,class (:foreground ,lambda-faint))))
...
;;;;;; Window Divs
     ...
     `(window-divider                            ((,class (:foreground ,lambda-black))))
     `(window-divider-first-pixel                ((,class (:foreground ,lambda-black))))
     `(window-divider-last-pixel                 ((,class (:foreground ,lambda-black))))
...
;;;;;; Bookmarks
     ...
     `(bookmark-menu-bookmark                    ((,class (:foreground ,lambda-blue))))
     `(bookmark-face                             ((,class (:foreground ,lambda-blue))))
...
;;;;;; Hydra
     ...
     `(hydra-face-teal                           ((,class (:foreground ,lambda-blue :weight bold))))
...
;;;;;; Info (Documentation)
     ...
     `(info-index-match                          ((,class (:foreground ,lambda-yellow))))
     `(info-xref                                 ((,class (:foreground ,lambda-blue))))
...
;;;;;; Marginalia
     `(marginalia-documentation                  ((,class (:italic t :foreground ,lambda-faint))))
     `(marginalia-key                            ((,class (:foreground ,lambda-yellow))))

;;;;;; Message-mode
     `(message-header-to                         ((,class (:inherit font-lock-variable-name-face))))
     `(message-header-cc                         ((,class (:inherit font-lock-variable-name-face))))
     `(message-header-subject                    ((,class (:foreground ,lambda-yellow :weight bold))))
...
;;;;;; Package (M-x list-packages)
     ...
     `(package-status-dependency                 ((,class :foreground ,lambda-yellow)))
...
;;;;;; Neotree
     ...
     `(neo-expand-btn-face                       ((,class (:foreground ,lambda-yellow))))
...
;;;;;; Outline
     `(outline-minor-0      ((,class (:background ,lambda-lowlight))))
     `(outline-1            ((,class (:inherit 'default :foreground ,lambda-red))))
     `(outline-2            ((,class (:inherit 'default :foreground ,lambda-red))))
     `(outline-3            ((,class (:inherit 'default :foreground ,lambda-red))))
     `(outline-4            ((,class (:inherit 'default :foreground ,lambda-red))))
...
;;;;;; Org Base Theme
     ...
     `(org-cite-key                                 ((,class (:foreground ,lambda-yellow))))
     ...
     `(org-document-title                           ((,class (:inherit ,(if lambda-themes-set-variable-pitch 'variable-pitch 'default) :height 2 :foreground ,lambda-fg :weight medium))))
     ...
     `(org-imminent-deadline                        ((,class (:foreground ,lambda-red))))
     ...
     `(org-link                                     ((,class (:foreground ,lambda-blue))))
     ...
     `(org-scheduled-today                          ((,class (:foreground ,lambda-blue))))
     ...
     `(org-warning                                  ((,class (:foreground ,lambda-yellow))))
;;;;;; Org-agenda
     ...
     `(org-agenda-date                              ((,class (:foreground ,lambda-blue))))
...
;;;;;; Anzu-mode
     ...
     `(anzu-match-3                              ((,class (:background ,lambda-blue))))
...
;;;;;; Isearch
     ...
     `(evil-ex-search                               ((,class (:background ,lambda-blue))))
     `(isearch                                      ((,class (:background ,lambda-blue :foreground ,lambda-highlight :weight bold))))
     `(isearch-fail                                 ((,class (:background ,lambda-red))))
...
;;;;;; Wgrep
     ...
     `(wgrep-done-face                            ((,class (:foreground ,lambda-blue))))
...
;;;;;; Term
     ...
     `(term-color-cyan                           ((,class (:foreground ,lambda-blue :background ,lambda-blue))))
...
;;;;;; Shell script
     ...
     `(sh-heredoc                                ((,class (:foreground ,lambda-yellow))))
...
;;;;;; Eat (Emulate a Terminal)
     ...
     `(eat-term-color-6                          ((,class (:foreground ,lambda-blue))))
     ...
     `(eat-term-color-10                         ((,class (:foreground ,lambda-yellow))))
     ...
     `(eat-term-color-14                         ((,class (:foreground ,lambda-blue))))
...
;;;;;; Eshell
     ...
     `(eshell-ls-clutter                          ((,class (:foreground ,lambda-yellow :weight bold))))
...
;;;;; Mu4e
     ...
     `(mu4e-contact-face                            ((,class (:foreground ,lambda-blue))))
     ...
     `(mu4e-highlight-face                          ((,class (:foreground ,lambda-blue))))
     `(mu4e-link-face                               ((,class (:foreground ,lambda-blue))))
     ...
     `(mu4e-replied-face                            ((,class (:foreground ,lambda-yellow))))
     `(mu4e-special-header-value-face               ((,class (:inherit   default))))
     `(mu4e-system-face                             ((,class (:foreground ,lambda-mild))))
     `(mu4e-title-face                              ((,class (:weight bold :foreground ,lambda-yellow))))
     ...
     `(mu4e-warning-face                            ((,class (:foreground ,lambda-red))))

;;;;; Circe
     `(circe-prompt-face               ((,class (:foreground ,lambda-blue))))
...
;;;;; Erc
     ...
     `(erc-input-face             ((,class (:foreground ,lambda-blue))))
     `(erc-my-nick-face           ((,class (:foreground ,lambda-blue))))
     ...
     `(erc-prompt-face            ((,class (:foreground ,lambda-blue))))
     `(erc-pal-face               ((,class (:foreground ,lambda-yellow :weight bold))))
     `(erc-keyword-face           ((,class (:foreground ,lambda-yellow :weight bold))))
...
;;;;; Gnus
     ...
     `(gnus-cite-10                ((,class (:foreground ,lambda-yellow))))
     `(gnus-cite-11                ((,class (:foreground ,lambda-yellow))))
     `(gnus-signature              ((,class (:foreground ,lambda-yellow))))
...
;;;;;; Basic Modeline/Headerline
    `(mode-line          ((,class (:foreground ,lambda-fg   :background ,lambda-bg :weight bold :underline ,lambda-fg))))
    `(mode-line-inactive ((,class (:foreground ,lambda-faint :background ,lambda-bg :weight bold :underline ,lambda-faint))))
...
;;;;;; Doom Modeline
     ...
     `(doom-modeline-bar ((,class (:background ,lambda-blue :foreground ,lambda-blue))))
     `(doom-modeline-bar-inactive ((,class (:background ,lambda-lowlight :box (:line-width 1 :color ,lambda-lowlight :style nil)))))
     `(doom-modeline-evil-emacs-state    ((,class (:inherit bold :foreground ,lambda-blue))))
...
;;;;;; Lambda-line
     ...
     `(lambda-line-inactive-status-RO   ((,class (:foreground ,lambda-meek   :inverse-video ,(if lambda-line-status-invert t nil)
                                                  :box ,(if lambda-line-status-invert `(:line-width 1 :color ,lambda-mild :style nil)
                                                          `(:line-width 1 :color ,lambda-ultralight :style nil))))))
     `(lambda-line-visual-bell          ((,class (:background ,lambda-red))))
...
;;;;;; Smart-mode-line
     ...
     `(persp-selected-face                       ((,class (:foreground ,lambda-yellow))))
...
;;;;;; Mood-line
     ...
     `(mood-line-status-error   ((,class (:inherit bold :foreground ,lambda-red))))
     `(mood-line-status-info    ((,class (:foreground ,lambda-blue))))
...
(defun lambda-themes--evil-load-cursors ()
  ...
  (setq evil-emacs-state-cursor    `('lambda-blue box))
  (setq evil-normal-state-cursor   `('lambda-yellow box))
  (setq evil-visual-state-cursor   `('lambda-meek box))
  (setq evil-insert-state-cursor   `('lambda-red (bar . 2)))
  (setq evil-replace-state-cursor  `('lambda-red hbar))
  (setq evil-motion-state-cursor   `('lambda-green box))
  (setq evil-operator-state-cursor `('lambda-yellow hollow)))
