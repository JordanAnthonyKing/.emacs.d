...
;;; Special purpose
      ...
      (bg-mode-line-active        "#f2f2f2")
      (fg-mode-line-active        "#000000")
      (border-mode-line-active    "#000000")
      (bg-mode-line-inactive      "#fff")
      (fg-mode-line-inactive      "#999")
      (border-mode-line-inactive  "#999")
