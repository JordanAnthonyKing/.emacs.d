...
;;;;; other custom faces
    ...
    `(modus-themes-key-binding ((,c :inherit (modus-themes-fixed-pitch) :foreground ,fg-main :background ,bg-ochre :box (:line-width -1 :color ,fg-dim))))
...
;;;;; basic and/or ungrouped styles
    ...
    `(highlight ((,c :background ,fg-main :foreground ,bg-main :box (:color ,fg-main))))
...
;;;;; buttons, links, widgets
    ...
    `(button ((,c :foreground ,blue :underline t)))
    `(link ((,c :inherit button)))
    `(link-visited ((,c :inherit link :foreground ,magenta)))
...
;;;;; custom (M-x customize)
    `(custom-button ((,c :box (:line-width -1 :color ,fg-main))))
    `(custom-button-mouse ((,c :inherit (highlight custom-button))))
    ;; `(custom-button-mouse ((,c :inherit (custom-button) :background ,fg-main)))
    `(custom-button-pressed ((,c :inherit (secondary-selection custom-button))))
    `(custom-button-unraised ((,c :inherit custom-button)))
    `(custom-link ((,c :inherit custom-button :background ,bg-blue-intense :foreground ,bg-main)))
    ...
    `(custom-visibility ((,c :foreground ,blue)))
;;;;; dashboard
...
;;;;; magit
    ...
    `(magit-blame-name (( )))
    `(magit-blame-summary ((  )))
    `(magit-branch-local ((,c :foreground ,bg-main :background ,bg-green-intense :box (:line-width (1 . -2) :color ,fg-main) :overline ,bg-main )))
    `(magit-branch-remote ((,c :foreground ,bg-main :background ,bg-blue-intense :box (:line-width (1 . -2) :color ,fg-main) :overline ,bg-main )))
    ...
    `(magit-hash ((,c :foreground ,fg-main :background ,bg-yellow-intense :box (:line-width -1 :style released-button))))
    `(magit-head ((,c :inherit magit-branch-local)))
    ;; `(magit-header-line ((,c :inherit bold)))
    `(magit-header-line ((,c :inherit mode-line :background "#fff5b1")))
    ...
    `(magit-log-author ((,c :foreground ,name :background ,bg-main :box nil)))
    `(magit-log-date ((,c :foreground ,date-common :background ,bg-main :box nil)))
...
;;;;; org
    ...
    `(org-document-title ((,c :inherit modus-themes-heading-0 :height 2.0)))
    ...
    `(org-level-2 ((,c :foreground ,red)))
    `(org-level-3 ((,c :foreground ,red)))
    `(org-level-4 ((,c :foreground ,red)))
    `(org-level-5 ((,c :foreground ,red)))
    `(org-level-6 ((,c :foreground ,red)))
    `(org-level-7 ((,c :foreground ,red)))
    `(org-level-8 ((,c :foreground ,red)))
...
;;;;; tab-bar-mode
    `(tab-bar ((,c :inherit modus-themes-ui-variable-pitch :box 1 :background ,bg-tab-bar)))
...
;;;;; tab-line-mode
    `(tab-line ((,c :inherit modus-themes-ui-variable-pitch :box 1 :background ,bg-tab-bar :height 0.95)))
...
;;;;; widget
    ...
    `(widget-inactive ((,c :inherit button :foreground ,fg-dim :background ,bg-dim)))
